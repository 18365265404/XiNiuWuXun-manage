                ...
                this.$refs[formName].validate((valid) => {
                    ...
                    if (valid) {
                        ...
                        postRequest(url.systemUserGoLogin, {
                            ...
                            sessionStorage.putSessionStorage('upToken',data.data.data.upToken)
                            // //刷新token过期时间
                            // sessionStorage.putSessionStorage('refreshTime',data.data.data.expiresIn*100000)
                            // //登录成功的时间
                            // sessionStorage.putSessionStorage('loginTime',(new Date()).getTime())
