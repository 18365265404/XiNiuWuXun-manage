        ...
        <div class="select-box" style="">
            ...
            <div>
                <el-form :inline="true" ref="formInline" :model="formInline" class="demo-form-inline" >
                    ...
                    <el-form-item class="formCity" label="发货状态:" prop="statusValue" >
                        <el-select
        ...
        >
            ...
            width="150">
                <template slot-scope="scope">
                    ...
                    <el-button type="text" size="small" v-show="scope.row.consignmentStatus!='1'"  @click.native.prevent="deliver(scope.$index, tableList)" >发货</el-button>    
                </template>
            </el-table-column>
        </el-table>
  ...
  export default {
    ...
    data() {
        return {
            ...
            tableList:[],
            detailList:[],
            statusList:[{value:0,name:'未发货'},{value:1,name:'已发货'}],
            qiniuH:url.qiniuH,
            dialogVisible:false,
            page:{
                currentPage:1,  
    ...
    computed:{
        tableParams(){
            return {
                ...
                search:this.searchV,
                consignmentStatus:this.consignmentStatus
            }
        },
    },
    methods:{
        ...
        // 状态选择
        statusF(){
            this.consignmentStatus=this.formInline.statusValue
            this.initData(this.tableParams)
        },
        // 发货
        deliver(index, rows){
            postRequest(url.systemConsigUpdateStatusByOrderId, {
