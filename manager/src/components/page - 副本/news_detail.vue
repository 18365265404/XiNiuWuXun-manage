...
export default {
    ...
    methods:{
        ...
        addServer(pamas){
            postRequest(url.recommendedNewsDetailsInsertRecommendedNewsDetails, pamas).then(data=> {
                ...
                this.initData({
                    recommendedNewsId:this.firstId
                })
        ...
        initData(pamas){
            postRequest(url.recommendedNewsDetailsSelectByRecommendedNewsId, pamas).then(data=> {
    ...
    created(){
        let firstId=localStorage.getItem("news_id")
        this.firstId=firstId
        this.initData({
            recommendedNewsId:firstId
        })
        this.initQiniu()
