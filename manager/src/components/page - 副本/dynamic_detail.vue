...
export default {
    ...
    methods:{
        ...
        addServer(pamas){
            postRequest(url.companyDynamicsDetailsInsertCompanyDynamicsDetails, pamas).then(data=> {
                ...
                this.initData({
                    companyDynamicsId:this.firstId
                })
        ...
        initData(pamas){
            postRequest(url.companyDynamicsDetailsSelectByCompanyDynamicsId, pamas).then(data=> {
    ...
    created(){
        let firstId=localStorage.getItem("dynamic_id")
        this.firstId=firstId
        this.initData({
            companyDynamicsId:firstId
        })
        this.initQiniu()
